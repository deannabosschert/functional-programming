...
Later (during frontend data), create a data visualisation with d3 based on given data. See [frontend data repo](https://github.com/deannabosschert/frontend-data) for more.
